...
- **Check that the plugin loads.** `hermes plugins doctor <clone>/hosts/hermes` should print `OK: runtime discovery, manifest parsing, import, and registration passed`, with 6 hooks registered.
