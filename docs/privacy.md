...
- The graph and per-node calls get your prompt and the spec, not the conversation. The clarification call gets the spec, the node conclusions, the conversation excerpt and questions you already answered.
